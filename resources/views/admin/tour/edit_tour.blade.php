...
<section class="tour-lists p-8 ">
    <header class="tour-lists-header flex  items-center justify-between">
        <h1 class=" text-2xl font-semibold  capitalize">Edit Tour {{$tour->id}}</h1>
    </header>
            ...
            <div class="flex flex-col ">
                ...
                <div class="my-6 flex items-center justify-between">
                    ...
                    <div class="image flex items-center space-x-4 ">
                        <img id="image" src="{{asset('storage/'.$tour->tour_img)}}" class="@if(!$tour->tour_img) hidden @endif w-32 h-20 object-contain">
                        @if (!$tour->tour_img)
                    ...
                    <div class="image-upload">
                        ...
                        <input id="image_upload_input" type="file" name="tour_image" value="{{asset('storage/'.$tour->tour_img)}}" class="bg-indigo" hidden>
                    </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="tour_title" value="{{$tour->tour_title}}" id="tour_title" placeholder="Tour Title" class=" @error('tour_title') border-red-600 @enderror block w-full px-4 py-2 mt-2  placeholder-gray-400  border border-gray-300  rounded-lg bg-white text-gray-800  focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" />
                ...
                <div class="mb-4">
                    ...
                    <textarea name="tour_text" value="{{ $tour->tour_text}}" id="tour_text" cols="30" rows="5" placeholder="Tour Text" class=" @error('tour_text') border-red-600 @enderror block w-full px-4 py-2 mt-2  placeholder-gray-400  border border-gray-300  rounded-lg bg-white text-gray-800  focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40 resize-none">{{ $tour->tour_text}}</textarea>
