                ...
                <div class="flex items-center w-full max-w-md px-6 mx-auto lg:w-2/6">
                    <div class="flex-1">
                        <div class="text-center">
                            ...
                            <p class="mt-3 text-2xl md:text-4xl text-gray-500 dark:text-gray-300">Register</p>
                        </div>
                        ...
                        <div class="mt-8">
                            <form method="POST" action="{{route('register')}}">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="name" id="name" placeholder="Full Name" class=" @error('name') border-red-600 @enderror block w-full px-4 py-2 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-lg dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" />
                                    @error('name')
                                ...
                                <div class="mt-6">
                                    ...
                                    <input type="email" name="email" id="email" placeholder="example@example.com" class=" @error('name') border-red-600 @enderror block w-full px-4 py-2 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-lg dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" />
                                    @error('email')
                                    <span class="text-red-600 text-xs" role="alert"><strong>{{ $message }}</strong></span>
                                    @enderror
                                </div>
