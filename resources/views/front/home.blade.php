...
<main class="main">
    ...
    <section class="h-screen w-full shadow border-b-8 ">
        ...
        <div class=" flex flex-col justify-center items-center absolute top-2/4 left-2/4 -translate-x-2/4 -translate-y-2/4">
            <h1 class="landing-page-img__subject uppercase text-2xl md:text-6xl font-semibold text-gray-200 select-none">
                Explore Dream
            </h1>
            <h1 class="landing-page-img__subject uppercase text-2xl md:text-6xl font-semibold text-gray-200 select-none">Destinition</h1>
            ...
            <a href="#" class="px-8 py-4 leading-5 text-white transition-colors duration-300 transform bg-indigo-700 rounded-md hover:bg-indigo-600 focus:outline-none focus:bg-indigo-600 text-lg font-semibold ">Book A Tour</a>
        </div>
    </section>
    ...
    <div class="content px-4 md:px-36">
        ...
        <section class="more-about-us bg-[#fff] mt-20">
            <div class="flex flex-col justify-center items-center md:flex-row md:gap-20">
                <div class="h-full mb-3 md:w-1/2">
                    <img class="h-[12.5rem] w-screen md:h-[31.25rem] md:w-full object-cover shadow-md shadow-gray-600 rounded" src="{{asset('images/2.jpg')}}" alt="">
                </div>
                <div class="md:w-1/2">
                    <h1 class="m-2 text-center text-3xl uppercase text-indigo-700 font-semibold">Make the most of your </h1>
        ...
        <section class="tours mt-20">
            ...
            <div class="tour-cards flex flex-col items-center gap-4 flex-wrap md:flex-row  ">
                ...
                @if($loop->iteration <= 6)
                <div class="w-full max-w-[24.8rem] min-h-[25rem]  bg-white rounded shadow transition ease-linear delay-75  hover:-translate-y-1 hover:scale-105 duration-200">
                    <img class="object-cover w-full h-56" src="{{asset('storage/'.$tour->tour_img)}}" alt="tour image">
                    <div class="flex items-center px-6 py-3 bg-gray-800">
                        ...
                        <a href="https://www.google.com/maps/place/Dashoguz/@41.827586,59.9370288,15z/data=!4m6!3m5!1s0x41de6896264d2475:0x8314c6ef35c7a218!8m2!3d41.8368737!4d59.9651904!16zL20vMDc1Z2Nw?entry=ttu" target="__blank">
                            <h1 class="mx-3 text-lg font-semibold text-white  hover:underline hover:transition-all">{{$tour->tour_location_title}}</h1>
                        </a>
                    </div>

                    <div class="px-6 py-4">
                        <a href="{{route('home.tours.show',$tour->id)}}" class="text-xl font-semibold text-indigo-500 hover:text-indigo-700 hover:transition-colors">{{$tour->tour_title}}</a>
        ...
        {{--Most Populer Tours --}}
        {{-- <section class="most-populer-tours mt-20">
            <h1 class="text-center text-2xl uppercase font-semibold p-4 mb-8 text-indigo-700">Most Popular Tours</h1>
            <div class="tour-cards flex flex-col justify-center items-center md:flex-row gap-8 flex-wrap">
                ...
                <div class="w-full max-w-sm overflow-hidden bg-white rounded shadow transition ease-linear delay-75  hover:-translate-y-1 hover:scale-105 duration-200">
                    <img class="object-cover object-center w-full h-56" src="{{asset('/images/tour1.webp')}}" alt="avatar">
                    <div class="flex items-center px-6 py-3 bg-gray-800">
                        <svg aria-label="location pin icon" class="w-6 h-6 text-indigo-500 fill-current" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M16.2721 10.2721C16.2721 12.4813 14.4813 14.2721 12.2721 14.2721C10.063 14.2721 8.27214 12.4813 8.27214 10.2721C8.27214 8.063 10.063 6.27214 12.2721 6.27214C14.4813 6.27214 16.2721 8.063 16.2721 10.2721ZM14.2721 10.2721C14.2721 11.3767 13.3767 12.2721 12.2721 12.2721C11.1676 12.2721 10.2721 11.3767 10.2721 10.2721C10.2721 9.16757 11.1676 8.27214 12.2721 8.27214C13.3767 8.27214 14.2721 9.16757 14.2721 10.2721Z" />
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M5.79417 16.5183C2.19424 13.0909 2.05438 7.3941 5.48178 3.79418C8.90918 0.194258 14.6059 0.0543983 18.2059 3.48179C21.8058 6.90919 21.9457 12.606 18.5183 16.2059L12.3124 22.7241L5.79417 16.5183ZM17.0698 14.8268L12.243 19.8965L7.17324 15.0698C4.3733 12.404 4.26452 7.9732 6.93028 5.17326C9.59603 2.37332 14.0268 2.26454 16.8268 4.93029C19.6267 7.59604 19.7355 12.0269 17.0698 14.8268Z" />
                ...
                <div class="w-full max-w-sm overflow-hidden bg-white rounded shadow transition ease-linear delay-75  hover:-translate-y-1 hover:scale-105 duration-200 ">
                    <img class="object-cover object-center w-full h-56" src="{{asset('/images/tour2.webp')}}" alt="avatar">
                    <div class="flex items-center px-6 py-3 bg-gray-800">
                        <svg aria-label="location pin icon" class="w-6 h-6 text-indigo-500 fill-current" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M16.2721 10.2721C16.2721 12.4813 14.4813 14.2721 12.2721 14.2721C10.063 14.2721 8.27214 12.4813 8.27214 10.2721C8.27214 8.063 10.063 6.27214 12.2721 6.27214C14.4813 6.27214 16.2721 8.063 16.2721 10.2721ZM14.2721 10.2721C14.2721 11.3767 13.3767 12.2721 12.2721 12.2721C11.1676 12.2721 10.2721 11.3767 10.2721 10.2721C10.2721 9.16757 11.1676 8.27214 12.2721 8.27214C13.3767 8.27214 14.2721 9.16757 14.2721 10.2721Z" />
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M5.79417 16.5183C2.19424 13.0909 2.05438 7.3941 5.48178 3.79418C8.90918 0.194258 14.6059 0.0543983 18.2059 3.48179C21.8058 6.90919 21.9457 12.606 18.5183 16.2059L12.3124 22.7241L5.79417 16.5183ZM17.0698 14.8268L12.243 19.8965L7.17324 15.0698C4.3733 12.404 4.26452 7.9732 6.93028 5.17326C9.59603 2.37332 14.0268 2.26454 16.8268 4.93029C19.6267 7.59604 19.7355 12.0269 17.0698 14.8268Z" />
                ...
                <div class="w-full max-w-sm overflow-hidden bg-white rounded shadow transition ease-linear delay-75  hover:-translate-y-1 hover:scale-105 duration-200 ">
                    <img class="object-cover object-center w-full h-56" src="{{asset('/images/tour3.webp')}}" alt="avatar">
                    <div class="flex items-center px-6 py-3 bg-gray-800">
                        <svg aria-label="location pin icon" class="w-6 h-6 text-indigo-500 fill-current" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M16.2721 10.2721C16.2721 12.4813 14.4813 14.2721 12.2721 14.2721C10.063 14.2721 8.27214 12.4813 8.27214 10.2721C8.27214 8.063 10.063 6.27214 12.2721 6.27214C14.4813 6.27214 16.2721 8.063 16.2721 10.2721ZM14.2721 10.2721C14.2721 11.3767 13.3767 12.2721 12.2721 12.2721C11.1676 12.2721 10.2721 11.3767 10.2721 10.2721C10.2721 9.16757 11.1676 8.27214 12.2721 8.27214C13.3767 8.27214 14.2721 9.16757 14.2721 10.2721Z" />
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M5.79417 16.5183C2.19424 13.0909 2.05438 7.3941 5.48178 3.79418C8.90918 0.194258 14.6059 0.0543983 18.2059 3.48179C21.8058 6.90919 21.9457 12.606 18.5183 16.2059L12.3124 22.7241L5.79417 16.5183ZM17.0698 14.8268L12.243 19.8965L7.17324 15.0698C4.3733 12.404 4.26452 7.9732 6.93028 5.17326C9.59603 2.37332 14.0268 2.26454 16.8268 4.93029C19.6267 7.59604 19.7355 12.0269 17.0698 14.8268Z" />
                ...
                <div class="w-full max-w-sm overflow-hidden bg-white rounded shadow transition ease-linear delay-75  hover:-translate-y-1 hover:scale-105 duration-200 ">
                    <img class="object-cover object-center w-full h-56" src="{{asset('/images/tour4.webp')}}" alt="avatar">
                    <div class="flex items-center px-6 py-3 bg-gray-800">
                        <svg aria-label="location pin icon" class="w-6 h-6 text-indigo-500 fill-current" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M16.2721 10.2721C16.2721 12.4813 14.4813 14.2721 12.2721 14.2721C10.063 14.2721 8.27214 12.4813 8.27214 10.2721C8.27214 8.063 10.063 6.27214 12.2721 6.27214C14.4813 6.27214 16.2721 8.063 16.2721 10.2721ZM14.2721 10.2721C14.2721 11.3767 13.3767 12.2721 12.2721 12.2721C11.1676 12.2721 10.2721 11.3767 10.2721 10.2721C10.2721 9.16757 11.1676 8.27214 12.2721 8.27214C13.3767 8.27214 14.2721 9.16757 14.2721 10.2721Z" />
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M5.79417 16.5183C2.19424 13.0909 2.05438 7.3941 5.48178 3.79418C8.90918 0.194258 14.6059 0.0543983 18.2059 3.48179C21.8058 6.90919 21.9457 12.606 18.5183 16.2059L12.3124 22.7241L5.79417 16.5183ZM17.0698 14.8268L12.243 19.8965L7.17324 15.0698C4.3733 12.404 4.26452 7.9732 6.93028 5.17326C9.59603 2.37332 14.0268 2.26454 16.8268 4.93029C19.6267 7.59604 19.7355 12.0269 17.0698 14.8268Z" />
                        ...
                        <a href="https://www.google.com/maps/place/Dashoguz/@41.827586,59.9370288,15z/data=!4m6!3m5!1s0x41de6896264d2475:0x8314c6ef35c7a218!8m2!3d41.8368737!4d59.9651904!16zL20vMDc1Z2Nw?entry=ttu" target="__blank">
                            <h1 class="mx-3 text-lg font-semibold text-white hover:underline hover:transition-all">Mary</h1>
                        </a>
                    </div>

                    <div class=" px-6 py-4">
                        <a href="#" class="text-xl font-semibold text-indigo-500 hover:text-indigo-700 hover:transition-colors">Heart of the Karakum</a>
                        <p class="py-2 text-gray-600 overflow-hidden">This 7-day tour is for people with a general interest in Turkmenistan, wanting to explore as many aspects of the…</p>
                    </div>
                </div>

                <div class="w-full max-w-sm overflow-hidden bg-white rounded shadow transition ease-linear delay-75  hover:-translate-y-1 hover:scale-105 duration-200 ">
                    <img class="object-cover object-center w-full h-56" src="{{asset('/images/tour5.webp')}}" alt="avatar">
                    <div class="flex items-center px-6 py-3 bg-gray-800">
                        <svg aria-label="location pin icon" class="w-6 h-6 text-indigo-500 fill-current" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M16.2721 10.2721C16.2721 12.4813 14.4813 14.2721 12.2721 14.2721C10.063 14.2721 8.27214 12.4813 8.27214 10.2721C8.27214 8.063 10.063 6.27214 12.2721 6.27214C14.4813 6.27214 16.2721 8.063 16.2721 10.2721ZM14.2721 10.2721C14.2721 11.3767 13.3767 12.2721 12.2721 12.2721C11.1676 12.2721 10.2721 11.3767 10.2721 10.2721C10.2721 9.16757 11.1676 8.27214 12.2721 8.27214C13.3767 8.27214 14.2721 9.16757 14.2721 10.2721Z" />
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M5.79417 16.5183C2.19424 13.0909 2.05438 7.3941 5.48178 3.79418C8.90918 0.194258 14.6059 0.0543983 18.2059 3.48179C21.8058 6.90919 21.9457 12.606 18.5183 16.2059L12.3124 22.7241L5.79417 16.5183ZM17.0698 14.8268L12.243 19.8965L7.17324 15.0698C4.3733 12.404 4.26452 7.9732 6.93028 5.17326C9.59603 2.37332 14.0268 2.26454 16.8268 4.93029C19.6267 7.59604 19.7355 12.0269 17.0698 14.8268Z" />
                        ...
                        <a href="https://www.google.com/maps/place/Dashoguz/@41.827586,59.9370288,15z/data=!4m6!3m5!1s0x41de6896264d2475:0x8314c6ef35c7a218!8m2!3d41.8368737!4d59.9651904!16zL20vMDc1Z2Nw?entry=ttu" target="__blank">
                            <h1 class="mx-3 text-lg font-semibold text-white hover:underline hover:transition-all">Ahal</h1>
                        </a>
                    </div>

                    <div class="px-6 py-4">
                        <a href="#" class="text-xl font-semibold text-indigo-500 hover:text-indigo-700 hover:transition-colors">Special tour "Novruz holiday"</a>
                        <p class="py-2 text-gray-600 overflow-hidden">This 7-day tour is for people with a general interest in Turkmenistan, wanting to explore as many aspects of the…</p>
                    </div>
                </div>
            </div>
        ...
        {{-- City Tours --}}
        {{-- <section class="city-tours mt-10">
            <h1 class="text-center text-2xl uppercase text-indigo-700 font-semibold p-4 mb-8">City Tours</h1>
            <div class="tour-cards flex flex-col justify-center items-center md:flex-row gap-8 flex-wrap">
        ...
        <section class="counter my-36">
            <div class="counter_cards flex flex-col justify-around gap-2 md:flex-row  md:gap-8">
                ...
                <div class="counter_card p-16 m-auto w-3/4 md:w-1/4 flex flex-wrap flex-col justify-center items-center space-y-2 rounded shadow-lg shadow-gray-500 bg-gray-800 ">
                ...
                <div class="counter_card p-16 md:translate-y-8 m-auto w-3/4 md:w-1/4  flex flex-wrap flex-col justify-center items-center space-y-2 rounded shadow-lg shadow-gray-500 bg-gray-800 ">
                    <div class="counter_card__icon">
        ...
        <section class="mt-24">
            <div class="flex flex-col justify-center items-center  md:flex-row md:gap-16">
                <div class="p-8 bg-gray-800 rounded-lg shadow-black flex flex-col justify-center items-center mb-4  md:shadow-2xl  md:w-2/4 ">
                    <h1 class="text-center text-2xl  uppercase text-gray-200 font-semibold md:text-6xl">We will help you choose the perfect vacation!</h1>
                    <p class="text-sm text-gray-200">We will certainly take into account any wishes and can help you with the choice of rest or try something new!</p>
                ...
                <div class="choose_vocation_cards flex flex-col md:flex-row flex-wrap justify-between gap-4">
                    <div class="choose_vocation_card p-8 w-fit  flex flex-col grow justify-center items-center gap-2 rounded-lg shadow transition ease-linear delay-150  hover:-translate-y-1 hover:scale-105 duration-300">
                        <a href="#" class="w-fit rounded-full">
                            <div class=" choose_vocation_icon p-6 border rounded-full bg-indigo-500 hover:bg-indigo-700 hover:transition-colors">
                                <svg class="h-12 w-12 fill-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                    <!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2023 Fonticons, Inc. -->
                        ...
                        <a href="#">
                            <p class="choose_vocation_title text-gray-600 text-lg font-bold hover:text-gray-800 hover:transition-colors">Planning</p>
                        </a>
                    ...
                    <div class="choose_vocation_card p-8 w-fit  flex flex-col grow justify-center items-center gap-2 rounded-lg shadow transition ease-linear delay-150  hover:-translate-y-1 hover:scale-105 duration-300 ">
                        <a href="#" class="w-fit rounded-full">
                            <div class=" choose_vocation_icon p-6 border rounded-full bg-indigo-500 hover:bg-indigo-700 hover:transition-colors ">
                                <svg class="h-12 w-12 fill-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                    <!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2023 Fonticons, Inc. -->
                        ...
                        <a href="#">
                            <p class="choose_vocation_title text-gray-600 text-lg font-bold hover:text-gray-800 hover:transition-colors">Tour Selection</p>
                        </a>
                        <h1 class="choose_vocation_text text-gray-600">Contact us in any way convenient for you</h1>
                    </div>
                    <div class="choose_vocation_card p-8 w-fit flex flex-col grow  justify-center items-center gap-2 rounded-lg  shadow transition ease-linear delay-150  hover:-translate-y-1 hover:scale-105 duration-300">
                        <a href="#" class="w-fit rounded-full">
                            <div class=" choose_vocation_icon p-6 border rounded-full bg-indigo-500 hover:bg-indigo-700 hover:transition-colors">
                                <svg class="h-12 w-12 fill-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
                                    <!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2023 Fonticons, Inc. -->
                        ...
                        <a href="#">
                            <p class="choose_vocation_title text-gray-600 text-lg font-bold hover:text-gray-800 hover:transition-colors">Contact Us</p>
                        </a>
                        <h1 class="choose_vocation_text text-gray-600">Contact us in any way convenient for you</h1>
                    </div>
                </div>
        ...
        <section class="my-24">
            <div class="text-center mb-8">
                <h1 class="text-center text-2xl uppercase text-indigo-700 font-semibold"> Personals Populer Comments</h1>
                <p class="text-lg text-gray-600">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Harum eligendi aliquam, voluptatibus nam nihil sunt!</p>
            </div>
            <div class="cards flex flex-col md:flex-row justify-around gap-4  md:gap-8">
                <div class="card bg-gray-800 flex flex-col justify-center items-center   md:w-1/3 p-8 rounded-lg border-b-8 border-indigo-500 shadow-lg shadow-indigo-500">
                    <img class="object-cover w-24 h-24 mb-4 shadow rounded-full border-4 border-indigo-500" src="{{asset('images/people/1.jpg')}}" alt="">
                    <p class="person_comment  text-sm text-white italic mb-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dicta eveniet ab id nihil quibusdam distinctio debitis asperiores, vero animi dolorem aspernatur laudantium qui eum accusantium expedita atque fugiat modi? Ipsam totam rerum </p>
                    <h1 class="person_name text-white text-xl font-semibold">Nathan Taylor</h1>
                </div>
                <div class="card bg-gray-800 md:translate-y-8 flex flex-col justify-center items-center   md:w-1/3 p-8 rounded-lg border-b-8 border-indigo-500 shadow-lg shadow-indigo-500">
                    <img class="object-cover w-24 h-24 mb-4 shadow rounded-full border-4 border-indigo-500" src="{{asset('images/people/2.jpg')}}" alt="">
                    <p class="person_comment  text-sm text-white italic mb-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dicta eveniet ab id nihil quibusdam distinctio debitis asperiores, vero animi dolorem aspernatur laudantium qui eum accusantium expedita atque fugiat modi? Ipsam totam rerum </p>
                    <h1 class="person_name text-white text-xl font-semibold">Nathan Taylor</h1>
                </div>
                <div class="card bg-gray-800 flex flex-col justify-center items-center   md:w-1/3 p-8 rounded-lg border-b-8 border-indigo-500 shadow-lg shadow-indigo-500">
                    <img class="object-cover w-24 h-24 mb-4 shadow rounded-full border-4 border-indigo-500" src="{{asset('images/people/3.jpg')}}" alt="">
                    <p class="person_comment  text-sm text-white italic mb-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dicta eveniet ab id nihil quibusdam distinctio debitis asperiores, vero animi dolorem aspernatur laudantium qui eum accusantium expedita atque fugiat modi? Ipsam totam rerum </p>
                    <h1 class="person_name text-white text-xl font-semibold">Nathan Taylor</h1>
                </div>
            </div>
