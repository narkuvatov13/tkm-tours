...
@section('content')
    ...
    <main class="container p-10 mt-4 mx-auto">
        ...
        <section class="most-populer-tours">
            <div class="tour-cards flex flex-col justify-center items-center md:flex-row gap-4 flex-wrap">

                @foreach ($tours as $tour)
                    <div
                        class="w-full max-w-sm overflow-hidden bg-white rounded shadow transition ease-linear delay-75  hover:-translate-y-1 hover:scale-105 duration-200">
                        <img class="object-cover object-center w-full h-56" src="{{asset('storage/' . $tour->tour_img)}}"
                            alt="tour_img">
                        <div class="flex items-center px-6 py-3 bg-gray-800">
                            <svg aria-label="location pin icon" class="w-6 h-6 text-indigo-500 fill-current" viewBox="0 0 24 24"
