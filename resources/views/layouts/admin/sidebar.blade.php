...
<sidebar class="flex flex-col px-8 py-4 bg-gray-900 max-h-screen h-screen w-max">
    ...
    <ul class=" flex flex-col space-y-2">
        ...
        <li class="flex items-center">
            <a href="{{route('itinerary.index')}}" class=" flex items-center  rounded-md space-x-4 py-3 pl-4 pr-8 text-center  w-full  cursor-pointer outline-none hover:bg-indigo-600 transition-colors">
                <svg class="w-10 h-6 fill-gray-200" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
