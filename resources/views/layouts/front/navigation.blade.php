    ...
    <nav class=" absolute lg:sticky lg:top-0 invisible lg:visible  shadow lg:w-full   bg-gray-800 z-20">
        <div class="container   px-6 py-4 mx-auto">
            <div class="lg:flex lg:items-center lg:justify-between">
                ...
                <div
                    class="absolute inset-x-0 z-30 w-full px-6 py-4bg-gray-800 lg:mt-0 lg:p-0 lg:top-0 lg:relative lg:bg-transparent lg:w-auto lg:opacity-100 lg:translate-x-0 lg:flex lg:items-center">
                    {{-- List Items --}}
                    <div class="flex flex-col lg:flex-row lg:items-center lg:mx-8">
                        ...
                        <div class="group relative flex flex-col " id="adsada">
                            {{-- Dropdown Button --}}
                            <div
                                class="flex flex-row items-center px-3 py-2  mt-2 mb-2 lg:mb-0 text-gray-200 transform rounded-md lg:mt-0 hover:bg-gray-700 select-none ">
                                <a href="{{route('tours')}}" class="flex flex-col mx-2">
                                    Tours
                                </a>
                            </div>
                        </div>
                        ...
                        <a href="{{route('services.index')}}"
                            class="px-3 py-2 mx-3 mt-2 text-gray-700 transition-colors duration-300 transform rounded-md lg:mt-0 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700">Services</a>
                        {{-- Travel Info --}}
                        <a href="{{route('travel-info.index')}}"
                            class="px-3 py-2 mx-3 mt-2 text-gray-700 transition-colors duration-300 transform rounded-md lg:mt-0 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700">Travel
                            Info</a>
                        ...
                        <div class="group relative flex flex-col ">
                            ...
                            {{-- Dropdown Content --}}
                            <div
                                class=" flex flex-col justify-center lg:w-max p-2 rounded-lg lg:group-hover:visible lg:invisible lg:absolute lg:top-10 lg:left-0 bg-gray-600 lg:bg-gray-800 lg:rounded-md">
                                <a href="{{ route('about.index') }}"
                                    class="p-2 transition-colors duration-300 transform rounded-md lg:mt-0 text-gray-200 hover:bg-gray-500 ">
                                    About Us
                                </a>
                                <a href="{{route('about-country.index')}}"
                                    class="p-2 transition-colors duration-300 transform rounded-md lg:mt-0 text-gray-200 hover:bg-gray-500 ">
                                    About Country
                                </a>
                            </div>
                        ...
                        <a href="{{route('contact-us.index')}}"
                            class="px-3 py-2 mx-3 mt-2 text-gray-700 transition-colors duration-300 transform rounded-md lg:mt-0 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700">Contact
                            Us</a>
                        @auth
                            <a href="{{ route('admin.index') }}"
                                class="px-3 py-2 mx-3 mt-2 text-gray-700 transition-colors duration-300 transform rounded-md lg:mt-0 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700">Admin</a>
                        @endauth
                        @guest
                ...
                <div x-cloak :class="[isOpen ? 'translate-x-0 opacity-100 ' : 'opacity-0 -translate-x-full']"
                    ...
                    <div class="flex flex-col lg:flex-row lg:items-center lg:mx-8">
                        ...
                        {{-- <div x-data="{ isOpen: false }" class="group relative flex flex-col ">
                            ...
                            <div x-cloak @click="isOpen = !isOpen"
                                class="flex flex-row items-center px-3 py-2  mt-2 mb-2 lg:mb-0 text-gray-200 transform rounded-md lg:mt-0 hover:bg-gray-700 select-none ">
                                <a href="#" class="flex flex-col mx-2">
                                    Services
                                </a>
                                <svg x-show="!isOpen"
                                    class=" h-6 w-6  fill-gray-200 transition ease-linear duration-700 delay-700 "
                                ...
                                <svg x-show="isOpen"
                                    class="h-6 w-6 fill-gray-200 transition ease-linear delay-150 duration-300"
                                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
                                    <!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2023 Fonticons, Inc. -->
                                    <path
