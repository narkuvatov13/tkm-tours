...
<head>
    ...
    <title>Turkmenistan Tours dsa</title>
    {{-- Links --}}
    ...
    <div>
        ...
        <nav x-data="{ isOpen: false }" class="fixed top-0 w-full opacity-80 bg-[#0F172A] shadow-md z-50">
            <div class="container px-6 py-4 mx-auto md:flex md:justify-between md:items-center">
                ...
                <div x-cloak :class="[isOpen ? 'translate-x-0 opacity-100 mt-4' : '-translate-x-full ']"
                    class="absolute inset-x-0 w-full px-6 py-4 transition-all duration-300 ease-in-out bg-gray-800 md:mt-0 md:p-0 md:top-0 md:relative md:bg-transparent md:w-auto md:opacity-100 md:translate-x-0 md:flex md:items-center">
                    <div class="flex flex-col justify-center items-center md:flex-row md:mx-6">
                        <a class="my-2 text-white md-text-gray-700  transition-colors duration-300 transform hover:text-indigo-600 md:mx-4 md:my-0"
                            href="#">Home</a>
                        <a class="my-2 text-white md-text-gray-700  transition-colors duration-300 transform hover:text-indigo-600 md:mx-4 md:my-0"
                            href="#">Tours</a>
                        <a class="my-2 text-white md-text-gray-700  transition-colors duration-300 transform hover:text-indigo-600 md:mx-4 md:my-0"
                        ...
                        <a class="my-2 text-white md-text-gray-700  transition-colors duration-300 transform hover:text-indigo-600 md:mx-4 md:my-0"
                            href="#">Contact</a>
                        {{-- <a
                            class="my-2 text-white md-text-gray-700  transition-colors duration-300 transform hover:text-blue-600 md:mx-4 md:my-0"
                            href="#">Services</a> --}}
                        {{-- <a
                            class="my-2 text-white md-text-gray-700  transition-colors duration-300 transform hover:text-blue-600 md:mx-4 md:my-0"
                            href="#">Travel Info</a> --}}
        ...
        <main class="main">
            ...
            <section class="h-screen w-full shadow">
                <div
                    ...
                    <button
                        class="text-gray-300 font-semibold z-10 text-xl py-3 px-4 bg-indigo-600 inline-block w-48 rounded transition-colors hover:bg-indigo-800">Book
                        A Tour</button>
                </div>
            ...
            <section class="more-about-us p-8 bg-[#fff]">
                <div class="p-4 flex flex-col md:flex-row">
                    <div class=" w-fit md:w-1/2 p-4 max-w-fit flex flex-col">
                        <h1 class="text-center text-2xl uppercase text-gray-700 font-semibold">Make the most of your
                            travel with us!</h1>
                        <p class=" text-lg text-gray-700 text-justify mb-2 md-4">
                            We like to think of ourselves as the funnest travel company in Turkmenistan, run by a team
                            of awesome locals.
                            Our vision is to create unforgettable local experiences for all our guests visiting
                            Turkmenistan!
                            As your tour partner, we’ll help you disconnect from your everyday world, so you can immerse
                            yourself in local culture and reconnect with yourself.
                        </p>
                        <a href="#"
                            class="bg-indigo-600 py-2 px-4 self-center  text-white rounded hover:bg-indigo-700 transition-colors">
                            More About Us</a>
                    </div>
                    <div class="flex flex-col justify-center items-center space-y-6 md:w-1/2 rounded ">
                        <a href="#"
                            class="px-4 py-2 text-white text-center md:w-2/3 bg-indigo-600 hover:bg-indigo-700 transition-colors">Book
                            Now</a>
                        <a href="#"
                            class="px-4 py-2 text-white text-center md:w-2/3 bg-indigo-600 hover:bg-indigo-700 transition-colors">Sending
                            Email</a>
                    </div>
                </div>
            </section>
                ...
                <div class="tour-cards flex flex-col justify-center items-center md:flex-row gap-8 flex-wrap">
                    ...
                    <div class="w-full max-w-sm overflow-hidden bg-white rounded shadow-lg ">
                        ...
                        <div class="flex items-center px-6 py-3 bg-gray-900">
                            <svg aria-label="location pin icon" class="w-6 h-6 text-indigo-600 fill-current"
                        ...
                        <div class="px-6 py-4">
                            ...
                            <p class="py-2 text-gray-700 overflow-hidden">This 7-day tour is for people with a general
                                interest in Turkmenistan, wanting to explore as many aspects of the…</p>
                        </div>
                    </div>
                    ...
                    <div class="w-full max-w-sm overflow-hidden bg-white rounded shadow-lg ">
                        ...
                        <div class="px-6 py-4">
                            <a href="#" class="text-xl font-semibold text-indigo-600 ">Special tour "Ahalteke
                                Horses"</a>
                            <p class="py-2 text-gray-700 overflow-hidden">This 7-day tour is for people with a general
                                interest in Turkmenistan, wanting to explore as many aspects of the…</p>
                        </div>
            ...
            <section>
                <div class="text-center">
                    <h1 class="text-center text-2xl uppercase text-gray-700 font-semibold">We will help you choose the
                        perfect vacation!</h1>
                    <p class="text-lg text-gray-700">We will certainly take into account any wishes and can help you
            ...
            <div class="container px-6 py-8 mx-auto">
                <div class="grid gap-8 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                    ...
                    <div>
                        ...
                        <p
                            class="block mt-5 text-sm font-medium text-gray-500 duration-700 dark:text-gray-300 hover:text-gray-400 dark:hover:text-gray-200">
                            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Est ad maxime error quas ea
                            molestias eveniet tempora nostrum repellat ut!
                        </p>
                    </div>
                </div>
